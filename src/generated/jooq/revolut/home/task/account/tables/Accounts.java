...
public class Accounts extends TableImpl<AccountsRecord> {
    ...
    private static final long serialVersionUID = 1226027895;
     ...
     */
    public final TableField<AccountsRecord, String> CURRENCY = createField(DSL.name("CURRENCY"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.ACCOUNTS.BALANCE</code>.
     */
    public final TableField<AccountsRecord, BigDecimal> BALANCE = createField(DSL.name("BALANCE"), org.jooq.impl.SQLDataType.DECIMAL.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.ACCOUNTS.CREATED</code>.
     */
    public final TableField<AccountsRecord, Timestamp> CREATED = createField(DSL.name("CREATED"), org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).nullable(false), this, "");
    ...
    public List<ForeignKey<AccountsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsRecord, ?>>asList(Keys.CONSTRAINT_AF);
    }

    public Currencies currencies() {
        return new Currencies(this, Keys.CONSTRAINT_AF);
    }
